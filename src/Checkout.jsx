...
const Checkout = () => {
  return (
    <div className="bg-[#FFF4F4] w-full h-auto overflow-x-hidden overflow-y-auto">
      {/* Header */}
      <header className="p-4 md:p-8 h-auto md:h-[140px] w-full">
        <div className="container mx-auto flex flex-col md:flex-row gap-4 md:gap-8">
          ...
          <nav className="flex space-x-4 md:space-x-16 mt-2 md:mt-0 md:ml-80">
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex justify-center mt-8">
          <Link to="/carddetails" className=" ">
            <button className="lg:w-[800px] md:w-[600px] sm:w-[500px] py-2 bg-red-500 text-white font-bold rounded-full">
              Place Order
            </button>
          </Link>
        </div>
